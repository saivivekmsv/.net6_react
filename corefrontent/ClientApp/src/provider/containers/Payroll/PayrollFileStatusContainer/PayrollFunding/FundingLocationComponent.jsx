...
import { formFields, managePayrollFormNames,  usDateFormat } from "../../../../utils";
import { get } from "lodash";
import { Field, useFormikContext, FieldArray } from "formik";
import { FieldDropSide, DropdownWithImage } from "../../../../components";
              ...
              <div className="payroll-file-table-view">
                <div className="d-flex justify-content-between">
                  ...
                  <div>
                    ...
                    <p className="ft-14 black-text">{usDateFormat(data.payDate)}</p>
                  </div>
                  <div>
