...
const FormControlSearch = ({
  ...
  const buttonClass =
    screen === "plan-group-home" ? "close-button-pg" : "close-button-wrapper" || "sponsor-employee" ? "close-button-sponsor" : "close-button-wrapper"
  const iconClass = screen === "plan-group-home" || 'sponsor-employee' ? "icon-size" : "close-button"|| "sponsor-employee" ?  "icon-size" : "close-button"
  const onMouseMove = () => {
