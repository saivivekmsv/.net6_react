...
import { getManageEmployeeMaster } from "../../../../shared/services";
...
const SponsorEmployeeContainer = (data) => {
    ...
    const {response : employee, isLoading : loading} = useRequest({
    ...
    const {response: companyDetails} = useRequest({
        method: getCompanyDetails,
        payload: 7, //companyId
    });


    const logo = get(companyDetails, "logo", "");
    const bitFlags = {
        enrolled: 1,
        eligible: 2,
        ineligible: 4,
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div style={{ width: "203px" }}>
                        <SponsorPlanDropdown
                            placeHolder="Select"
                            options={get(companyDetails, "plans", [])}
                            setPlan={setPlanName}
                        />
                    </div>
                    <div className="selected-plan">{planName?.planName}</div>
            ...
            >
                ...
                <div className="flex-row space-between border-bottom ">
                    ...
                    >
                        <SponsorPlanDropdown options={sort} icon={<i class="fas fa-sort-amount-up" style={{ marginRight: '10px' }}></i>} setPlan={setPlanName} />
                    </div>
                    <div
                        style={{
                            fontSize: "14px",
