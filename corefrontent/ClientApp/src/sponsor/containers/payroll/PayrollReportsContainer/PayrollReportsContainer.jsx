...
import { ExcelDropDown, SliderPanel } from "../../../../shared/components";
...
import Logo from "../../../../shared/styles/upload.png";
...
const PayrollReportsContainer = (props) => {
  ...
  // console.log(payrollReports,isLoading,"DATA")
    ...
    <>
      <div className="payroll-report-container w-100">
        ...
        >
          ...
          <ContributionBreak data={payrollReports} />
        </SliderPanel>
      </div>
    </>
  );
