...
export const getSummaryReport = (payload) => {
  return apiInstance().post(
    `${endPoints.census.getEligibilitySummaryReport}`,
    payload
  );
};
export const getDetailReport = (payload) => {
  return apiInstance().post(
    `${endPoints.census.getEligibilityDetailReport}`,
    payload
  );
};
...
export const saveEligibilityInformation = (payload) => {
  return apiInstance().post(
    `${endPoints.payroll.saveEligibilityInformation}`,
    payload
  );
};
...
export const getFilesCountBasedOnSearch = (payload) => {
  return apiInstance().post(`${endPoints.payroll.getFileUploadCount}`, payload);
};
...
export const getRevalidateFile = (payload) => {
  return apiInstance().post(`${endPoints.payroll.getRevalidateFile}`, payload);
};
...
export const getDuplicateRecord = (payload) => {
  return apiInstance().post(`${endPoints.payroll.getDuplicateRecord}`, payload);
};
...
export const submitAndUpdateECR = (payload, fileType) => {
  return apiInstance().post(
    `${endPoints.payroll.submitAndUpdateTempEmployeeInECR}/${fileType}`,
    payload
  );
};
...
export const getRecordDetailsInGetWarningScreen = (payload) => {
  return apiInstance().post(
    `${endPoints.payroll.getRecordDetailsInGetWarningScreen}`,
    payload
  );
};
...
export const acceptAllDataChangeValidationInaFile = (payload) => {
  return apiInstance().post(
    `${endPoints.payroll.acceptAllDataChangeValidationInaFile}`,
    payload
  );
};

export const acceptEmployeeWarnings = (payload) => {
  return apiInstance().post(
    `${endPoints.payroll.acceptEmployeeWarnings}`,
    payload
  );
};
...
export const getFundingTransactionDetailsOfEmployeeInPayrollSubmissionPage = ({
  fileId,
  employeeId,
}) => {
  return apiInstance().get(
    `${endPoints.payroll.getFundingTransactionDetailsOfEmployeeInPayrollSubmissionPage}/${fileId}/${employeeId}`
  );
};
...
export const retrieveBankDetails = (planId) => {
  return apiInstance().get(
    `${endPoints.payroll.retrieveBankDetails}/${planId}`
  );
};
...
export const getDownloadInputFileReport = (fileid) => {
  return fileApiInstance().get(
    `${endPoints.payroll.getDownloadUploadedFileReport}/${fileid}`
  );
};

export const getDownloadSubmittedFileReport = (fileid) => {
  return fileApiInstance().get(
    `${endPoints.payroll.getDownloadSubmittedFileReport}/${fileid}`
  );
};
