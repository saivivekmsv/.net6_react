const endPoints = {
  ...
  company: {
    ...
    uploadCompanyLogo: "/api/v1/Company/AddCompanyLogo",
    getCompanyLogo: "/api/v1/Company/GetCompanyLogo",
  ...
  plan: {
    ...
    getIRSLimits: "/api/v1/Plan/IRSLimits",
    getMasterplans: "/api/v1/Plan/MasterPlans",
  },
  ...
  payroll: {
    ...
    getFundingTransactionDetailsOfEmployeeInPayrollSubmissionPage:
      "/api/v1/Payroll/GetFundingTransactionDetailsOfEmployeeInPayrollSubmissionPage",
    ...
    retrieveBankDetails: "/api/v1/Payroll/RetreiveBankDetails",
    ...
    getRevalidateFile: "/api/v1/Payroll/RevalidateFile",
    ...
    acceptAllDataChangeValidationInaFile:
      "/api/v1/Payroll/AcceptDataChangeValidationInaFile",
    acceptEmployeeWarnings: "/api/v1/Payroll/AcceptEmployeeWarnings",
    saveEligibilityInformation: "/api/v1/Payroll/SaveEligibilityInformation",
    getDownloadUploadedFileReport: "/api/v1/Payroll/DownloadUploadedFile",

    getDownloadSubmittedFileReport: "/api/v1/Payroll/DownloadSubmittedFile",
    getRecordDetailsInGetWarningScreen:
      "/api/v1/Payroll/GetRecordDetailsInGetWarningScreen",
    getFileUploadCount: "/api/v1/Payroll/GetFileUploadCount",
  },
  census: {
    ...
    getEligibilitySummaryReport: "/api/v1/Eligibility/EligibilitySummaryReport",
    getEligibilityDetailReport: "/api/v1/Eligibility/EligibilityDetailReport",
    ...
    uploadEmployeeLogo: "/api/v1/Payroll/UploadEmployeeLogo",
    getEmployeeImage: "/api/v1/Payroll/GetEmployeeLogo",
  },
  eligibility: {
  ...
  reports: {
    ...
    getAllEmployeeRecords: "/api/v1/Report/GetAllFileEmployeeReport",
    getEmployeeTransactionDetails:
      "/api/v1/Report/GetEmployeePayDateLevelTransactionDetails",
    ...
    getDownloadUploadedFileReport: "/api/v1/Report/DownloadInputFile",
    getDownloadSubmittedFileReport: "/api/v1/Report/DownloadSubmittedFile",
    getDownloadAllFileEmployeeDetails:
      "/api/v1/Report/DownloadAllFileEmployeeDetails",
    // Manage Report
    ...
    getRehireParticipantsReportInformation:
      "/api/v1/Report/GetRehireParticipantsReport",
    getNewParticipantEligibilityReportInformation:
      "/api/v1/Report/GetNewParticipantEligibilityReport",
    ...
    getDownloadNewParticipantReport:
      "/api/v1/Report/DownloadNewParticipantsReport",
    getDownloadRehireReport: "/api/v1/Report/DownloadRehireParticipantsReport",
  },
  mapper: {
    getMappingProfiles: "/api/Mapping",
    searchProfiles: "/api/Mapping/SearchProfiles",
    getProfileData: "/api/Mapping",
    getProfiles: "/api/Mapping/GetProfiles",
    verifyMapService: "/api/Mapping/VerfiyObjectMap",
    saveOnProfileCreate: "/api/Mapping/SaveOnProfileCreate",
    cloneProfile: "/api/Mapping/CloneProfile",
    UpdateStatus: "/api/Mapping/UpdateStatus",
    mappingChange: "/api/Mapping/SaveOnMappingChange",
    profileNameChange: "/api/Mapping/UpdateProfileName",
    getActivePlans: "/api/Mapping/GetFilteredPlans",
    onAggregateSave: "/api/Mapping/SaveOnDeDupChange",
    onFilterSave: "/api/Mapping/SaveOnFilter",
    updatePlans: "/api/Mapping/UpdatePlans",
    saveTargetType: "/api/Mapping/SaveTargetType",
    onSchedulerSave: "/api/Mapping/SaveOnChannelChange",
    checkProfileNameExists: "/api/Mapping/CheckProfileNameExists",
  },
};
