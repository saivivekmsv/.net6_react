...
import payrollErrorsWarning from "../../../mocks/payrollErrorsWarning.json";
import {
  ssnMasking,
  usDateFormat,
  ROUTES,
...
const ErrorFoundInRecordsContainer = ({
  ...
  return (
    <div className="file-information">
      <div className="payroll-sub-head">
        <span
          onClick={() => {
            setErrorPage(false);
          }}
                    ...
                    <Nav variant="pills" className="flex-column">
                      ...
                      {filteredValues.map((item, index) => {
                        return (
                          <Nav.Item>
                            <Nav.Link
                              className={item.id == employeeId ? "active" : ""}
                              onClick={() => {
          ...
          <Tab eventKey="all_records" title={<div>All Records</div>}>
            <div className="vertical-tabs">
              ...
              >
                <div className="d-flex w-100">
                  <div
                    className="ssn-search-tabs-navs"
                    style={{ height: "30%" }}
                  >
                    <Nav
                      variant="pills"
                      className="flex-column"
                      defaultActiveKey={employeeId}
                    >
                      <div className="search-control-wrapper">
                        <FormControlSearch
                          type="search"
