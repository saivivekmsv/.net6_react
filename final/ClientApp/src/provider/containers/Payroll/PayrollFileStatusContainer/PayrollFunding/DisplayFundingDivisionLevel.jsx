...
const DisplayFundingDivisionLevel = ({ payrollId }) => {
  ...
  const payrollFundingPlanLevel = get(values, fields.fundingDivisions, []);
  ...
  useDeepEffect(() => {
    setFieldValue(fields.fundingDivisions, list);
  }, [list]);

  return (
    <div>
      <FieldArray name={fields.fundingDivisions}>
        {() => (
          <div>
            {!isEmpty(list) ? (
              list &&
                          ...
                          <div>
                            ...
                            <p className="ft-14 black-text">
                              <Field
                                ...
                                size="smd"
                                name={`${
                                  fields.fundingDivisions
                                }[0].${"planDetailsForDivisions"}[${index}].${
                                  fields.bankName
                                }`}
                                value={
                                  !isEmpty(values.fundingDivisions)
                                    ? values.fundingDivisions[0]
                                        .planDetailsForDivisions[index].bankName
                                    : null
                                }
                                noLabelTransform
                                direction="bottom"
                          ...
                          <Row>
                            ...
                            <Col md="8">
                              <PayrollForfeiture
                                ...
                                parentIndex={index}
                                parentFieldName={fields.fundingDivisions}
                              />
                            </Col>
                          </Row>
                        ) : (
