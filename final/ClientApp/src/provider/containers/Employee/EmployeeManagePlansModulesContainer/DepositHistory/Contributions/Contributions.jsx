...
const Contributions = (props) => {
  ...
  useDeepEffect(() => {
    ...
    getEmployeeManagePlans(censusId)
      .then((response) => {
        setCurrentPlan(response.find((_) => _.id === parseInt(planId)));
      })
      .catch((error) => {});
  }, [toggle]);
  ...
  const onViewButtonClick = (data) => {
    getSourceLevelContribution({
      ...
      uploadedThrough: data.uploadedThrough,
                  ...
                  <div className="d-flex justify-content-between compensation-container w-100">
                    ...
                    <div className="align-center">
                      <Button
                        ...
                        variant="secondary"
                        disabled={currentPlan.status != "Eligible"}
                      >
                        Add Contributions
                      </Button>
                    </div>
                      ...
                      const getContent = () => {
                        if (!isEmpty(item.link)) {
                          return (
                            ...
                            >
                              <Link>
                                {contributions[item.columnName] === null ||
