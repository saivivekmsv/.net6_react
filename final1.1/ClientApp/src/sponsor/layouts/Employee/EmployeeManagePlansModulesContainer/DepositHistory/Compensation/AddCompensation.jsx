...
const AddCompensations = (props) => {
  ...
  const onFormSubmit = (values, { setFieldError }) => {
    ...
    addEmployeeCompensation({
      ...
      payPeriodGrossCompensation: parseInt(values.payPeriodGrossCompensation),
      payPeriodPlanCompensation: parseInt(values.payPeriodPlanCompensation),
            ...
            >
              ...
              >
                <div
                  ...
                  style={{ paddingRight: "25rem", fontSize: "20px" }}
                >
                  Add Compensation
                </div>
