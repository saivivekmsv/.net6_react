...
import { withAppLayout } from "sponsor/hoc";
import { manageCensusFormNames, MANAGE_CENSUS_MENU } from "shared/utils"
import { ManageCensusRoutes } from "sponsor/routes";
import {
  manageCensusStore,
        ...
        <Row sm="12" className="h-100">
          <Col className="manage-company-column manage-menu-items">
            <div className="company-name-component">
              {censusId && <CensusMenuEmployeeDetails censusId={censusId} />}
            </div>
            <ManageCensusMenu
