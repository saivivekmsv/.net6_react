...
const ErrorListingPayroll = (props) => {
  ...
  const handleCheck = (item) => {
    ...
    const data = content.filter((_) => _.checked == true);
    if (isCensusWarning) acceptWarningCensus(data);
    if (isPayrollWarning) acceptWarningPayroll(data);
  };
