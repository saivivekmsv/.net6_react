...
const ManageAddPlanButton2 = (props) => {
  ...
  console.log(selectedPlanStatus);
  const labels = [];
  ...
  const { response: formValues, loading1 } = useRequest({
  ...
  useEffect(() => {
    setSelectedCount(0);
    // let result = [1, 2, 3, 4, 5, 6, 7].map((filterIndex) => tags.reduce((acc, person) => acc + 1, 0));
      ...
      >
        <div className="w-90 h-100 planSliderContainer">
          ...
          <div className="addPlansContent">
            <div className="leftcol" style={{ overflow: "scroll" }}>
              <div className="col1">
                          ...
                          <div className="tile-text pad-left-15">
                            ...
                            <div className="tile-number">
                              <div style={{ justifyContent: "space-between" }}>
                                {data.rkPlanNumber}
                                {data.company.name} {data.planType}
                              </div>
...
export default ManageAddPlanButton2;
