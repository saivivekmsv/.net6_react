...
const SchedulerCheckList = ({
  ...
  return (
    <div style={{ display: "flex" }}>
      <div className="dropdownCheckList" onMouseOut={() => setOpen(false)}>
        <div className="dropdownCheck-header" onClick={toggleDropdown}>
          {setLabel()}
        ...
        <div
          className={`dropdownCheck-body ${isOpen && "open"}`}
