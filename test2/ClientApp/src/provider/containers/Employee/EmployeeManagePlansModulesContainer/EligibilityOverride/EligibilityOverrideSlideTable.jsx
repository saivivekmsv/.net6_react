...
import { OPTIONS_DATA_MAPPER, usDateFormat } from "../../../../utils";
      ...
      >
        {columns.map((item, cellIndex) => {
          const getContent = () => {
            ...
            if (item.columnName === "eligibilityRunDate") {
              return (
                usDateFormat(eligibilityDetail[columnName]) +
                " " +
                moment(new Date(eligibilityDetail[columnName])).format("hh:mm")
              );
            } else return eligibilityDetail[columnName];
          };
          return (
          ...
          <Table.Td className="w-100 accordion-wrapper">
            <div className="d-flex justify-content-between w-100 py-3 pr-5">
              <div className="accordion-item">
                <div className="accordion-label">Payroll based eligibility</div>
              ...
              <div className="accordion-item">
                ...
                <div className="accordion-value">
                  {eligibilityDetail.correctionRecord}
                </div>
              </div>
              <div className="accordion-item">
