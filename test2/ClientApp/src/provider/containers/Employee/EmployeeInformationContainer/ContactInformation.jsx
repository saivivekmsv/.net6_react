...
import states from "../../../mocks/state.json";
...
const ContactInformationFields = (props) => {
  const toggle = () => {
    props.setAdditionalAddress(!props.additionalAddress);
  };
          ...
          {values[fields.additionalCountryId] == 2 && (
            <>
              ...
              <Field
                ...
                disabled={isEdit && !isSave}
                component={FieldInput}
                value={values[fields.additionalZipCode]}
              />
            </>
          )}
        </div>
