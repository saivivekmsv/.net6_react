...
import {
  manageReportsStore,
  setManageReportsFlow,
  setManageReportsToastInfo,
  getReportsDetailsAction,
} from "../../contexts";
import { useDeepEffect, useRouterParams } from "../../abstracts";
import {
  MANAGE_REPORTS_ROUTES,
  ROUTES,
  manageReportsFormNames,
  apiErrors,
  getPathWithParam,
  ALL_MANAGE_REPORTS_ROUTES,
} from "../../utils";
...
const ManageReportLayout = ({
  ...
  useDeepEffect(() => {
    if (isEmpty(apiData) && reportId) {
      dispatch(getReportsDetailsAction(reportId, dispatch, state));
      dispatch(setManageReportsFlow({ flow, reportId }));
    }
...
export default withRouter(ManageReportLayout);
