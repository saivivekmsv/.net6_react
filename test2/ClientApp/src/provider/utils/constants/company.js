...
export const MANAGE_COMPANY_ROUTES = {
  ...
  INCORPORATION_DETAILS: `${ROUTES.MANAGE_COMPANY}/company-details`,
...
export const MANAGE_COMPANY_MENU = [
  ...
  {
    id: "manageCompanyClassification",
